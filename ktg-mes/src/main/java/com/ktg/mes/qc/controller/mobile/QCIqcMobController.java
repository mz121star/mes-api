 ...
 */
@RestController
@RequestMapping("/mobile/qc/iqc")
public class QCIqcMobController extends BaseController {
    ...
    {
        //质量的质检记录编码自动生成
        String resultCode = autoCodeUtil.genSerialCode(UserConstants.QC_IQC_CODE,null);
        qcIqc.setIqcCode(resultCode);
